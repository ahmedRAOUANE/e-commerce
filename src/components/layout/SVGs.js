...
const photo = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M400 421.3V154.7c0-23.5-19.2-42.7-42.7-42.7H90.7C67.2 112 48 131.2 48 154.7v266.7c0 23.5 19.2 42.7 42.7 42.7h266.7c23.4-.1 42.6-19.3 42.6-42.8zM157.3 304l45.3 64 66.7-96 88 128H90.7l66.6-96z"></path>
    <path d="M421.3 48H154.7C131.2 48 112 67.2 112 90.7V96h261.3c23.5 0 42.7 19.2 42.7 42.7V400h5.3c23.5 0 42.7-19.2 42.7-42.7V90.7c0-23.5-19.2-42.7-42.7-42.7z"></path>
  </svg>
);
...
const file = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M854.6 288.7c6 6 9.4 14.1 9.4 22.6V928c0 17.7-14.3 32-32 32H192c-17.7 0-32-14.3-32-32V96c0-17.7 14.3-32 32-32h424.7c8.5 0 16.7 3.4 22.7 9.4l215.2 215.3zM790.2 326L602 137.8V326h188.2z"></path>
  </svg>
);
...
export const SVGs = {
  searchIcon: search,
  ntfcIcon: notification,
  clipperBoard: clipperBoard,
  musicNote: musicNote,
  mic: mic,
  micMute: micMute,
  play: play,
  threeDotes: threeDotes,
  threeDotesVertical: threeDotesVertical,
  photo: photo,
  home: home,
  file: file,
  cartShoping: cartShoping,
  bars: bars,
